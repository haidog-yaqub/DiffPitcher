...
parser.add_argument('-config', type=str, default='config/DiffLPC_24k.yaml')

parser.add_argument('-seed', type=int, default=98)
parser.add_argument('-amp', type=bool, default=True)
parser.add_argument('-compile', type=bool, default=False)

parser.add_argument('-data_dir', type=str, default='../24k_data/')
...
parser.add_argument('-log_dir', type=str, default='logs_dec_lpc_24k')
parser.add_argument('-ckpt_dir', type=str, default='ckpt_24k')
